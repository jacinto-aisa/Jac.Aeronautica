    ...
    public class FakeRepositorio : IEmbarqueRepositorio
    {
        ...
        public FakeRepositorio()
        {
            Embarques = new List<EmbarqueAvion>(){
                ...
                new EmbarqueAvion() { Id = 2,Aeronave=1,NumeroPasajeros=134,TripulantesId="1,2,3",Fecha = DateTime.Now.AddDays(-1)},
                new EmbarqueAvion() { Id = 3,Aeronave=1,NumeroPasajeros=34,TripulantesId="1,3",Fecha =DateTime.Now.AddDays(-10)},
                ...
                new EmbarqueAvion() { Id = 8,Aeronave=1,NumeroPasajeros=134,TripulantesId="1",Fecha = DateTime.Now.AddDays(1)},
